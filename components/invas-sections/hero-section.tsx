...
export function HeroSection() {
  ...
  return (
    ...
    <section ref={imageRef} className="container mx-auto px-4 py-12 mb-20">
        ...
        >
          <img src={"/invas/invas-about-us.jpg"} alt="" className="w-full max-w-4xl mx-auto rounded-[32px] hover:scale-105 hover:rotate-1 shadow-2xl transition-transform duration-500" />
        </div>
      </section>
    </>
  );
