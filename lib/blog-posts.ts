...
export const posts: Post[] = [
    ...
    "title": "The Digital Garage: How Vehiculars.ng Powers a Full-Range Automotive Service with Cloud PBX Infrastructure",
    "excerpt": "For a high-velocity B2C/B2B Service Provider like Vehicular, a mobile application means nothing if customers get a busy signal during an emergency. A quick and apt response is a core part of the brand's value and business model. IntarvAS exists to help customer-facing brands like Vehiculars live up to expectations by providing a PBX telecommunication infrastructure that enables them to serve and satisfy as many customers as possible.",
    "cta_label": "Read full case study",
    "cover_image": {
        "src": "/image/pbx/pbxHeroImg.png",
        "alt": "Cloud PBX call history dashboard shown on a smartphone and tablet",
        "description": "Split view of a mobile app showing total call stats and a tablet showing call history with employee names, durations, and timestamps"
    },
    "type": "case_study",
    "content": {
        "intro": "When Vehiculars set out to revolutionize the Nigerian automotive maintenance and documentation landscape, they faced the classic dilemma of the logistics age: how to manage a massive influx of daily customer interactions without dealing with poor network connections, missed calls and low completion rate. The answer lay in a strategic partnership with IntarvAS, a premium cloud PBX provider for modern businesses.\n\nBy deploying the comprehensive IntarvAS Cloud PBX Infrastructure, Vehiculars has transformed its operational backend into a scalable, highly responsive system that untangles complex logistics from traditional communication bottlenecks.",
        "challenge": {
        "heading": "The Challenge: Managing High-Friction Mobility Services",
        "description": "Vehiculars operates as a comprehensive digital department of motor vehicles (DMV), roadside rescue assistant, and auto-financing portal all in one. On any given Tuesday, their backend agents are simultaneously processing vehicle registration renewals, routing emergency tow trucks to stranded drivers, clearing car parts at the port, and qualifying leads for car loans.\n\nAs the platform scaled to thousands of daily active users across major hubs, legacy communication setups created severe operational blind spots:",
        "pain_points": [
            {
            "title": "Inbound Calls Not Connecting",
            "detail": "Legacy SIM cards and rigid mobile networks frequently crashed or maxed out during peak rush hours. This can result in immediate network rejections, completely blocking drivers from reaching emergency dispatchers."
            },
            {
            "title": "Low Call Completion Rates",
            "detail": "Because massive spikes in daily traffic constantly overloaded the hardware, the platform's connection success percentage reduced significantly. Dropped connections and failed attempts meant a stranded motorist was left vulnerable on a highway."
            },
            {
            "title": "Context Blindness Across Silos",
            "detail": "Customer inquiries, car document uploads, and service updates were scattered across separate mobile devices and personal WhatsApp numbers. Frontline support agents had no unified history of user interactions, slowing down critical delivery handoffs."
            },
            {
            "title": "Inflexible Routing Barriers",
            "detail": "Connecting a client instantly to the specific department they needed — such as matching a breakdown emergency directly with a roadside dispatch unit — was impossible without manual transferring, creating long wait times."
            },
            {
            "title": "Loss of Lead Visibility",
            "detail": "High-value auto-financing requests and corporate fleet contracts routinely slipped through the cracks because there was no centralized system to record call histories or track follow-up performance."
            }
        ]
        },
        "solution": {
        "heading": "The Solution: A Unified, Intelligent Cloud Telecom Engine",
        "description": "IntarvAS stepped in not merely as a service vendor, but as a partner, engineering a custom cloud telecommunications framework tailored for high-velocity logistics and digital services.\n\nThe transformation was built on five core operational pillars:",
        "pillars": [
            {
            "number": 1,
            "title": "Cloud PBX with Device-Agnostic Mobility",
            "detail": "At the heart of the technical overhaul is the IntarvAS Cloud PBX system. This technology completely freed the company's communication infrastructure from localized desk phones or single SIM hardware constraints. The entire phone network was digitized and hosted in a secure cloud environment.\n\nWhether an agent is working out of a central corporate office, tracking documentation at a government registry, or managing field operations on a smartphone, the system provides an identical, professional interface. A single business extension ring path lives simultaneously across a mobile phone, a PC dashboard, and a web browser."
            },
            {
            "number": 2,
            "title": "Interactive Voice Response (IVR) & Intelligent Queues",
            "detail": "To eliminate long wait times and messy call transfers, Vehiculars adopted an advanced, automated Interactive Voice Response (IVR) greeting.\n\nWhen a user calls the business hotline, they are greeted by a crisp, automated audio directory: \"Press 1 for Roadside Assistance; Press 2 for Vehicle Registration & Licenses; Press 3 for Auto Financing.\"\n\nThe system dynamically measures the type of inquiry and routes the caller straight to the exact department equipped to handle it. While the call rings through, customized queue music or informative audio guides keep the client engaged."
            },
            {
            "number": 3,
            "title": "Integrated WhatsApp Business API",
            "detail": "Recognizing that WhatsApp is the primary transactional channel for document collection in the region, IntarvAS integrated the official WhatsApp Business API directly into Vehiculars' backend. This enabled the deployment of intelligent IVR workflows over WhatsApp.\n\nAutomated, conversational AI bots walk users through routine tasks 24/7, such as selecting a pricing tier, submitting car model specifications, or scheduling vehicle inspection dates. For complex logistics, the bot seamlessly hands off the entire session log to a live relationship manager without losing any context."
            },
            {
            "number": 4,
        ...
        "description": "Transitioning to the IntarvAS cloud-native ecosystem unlocked the elasticity needed to scale operations flawlessly, leading to an immediate turnaround in daily efficiency metrics.",
        "outcomes": [
            {
    ...
    "content": {
        ...
        "pillars": [
            ...
            "description": "The central pillar of IntarvAS infrastructure is the complete digitalization of the corporate phone network.",
            "features": [
                {
            ...
            "description": "IntarvAS provides businesses with strategic corporate identities through customized, high-capacity numbering profiles.",
            "features": [
                {
                "name": "Vanity Numbers (0700)",
                "detail": "Creates memorable, branded phone words (e.g. 0700PROVIDUS) to boost marketing recall and customer inbound calls."
                },
                {
            ...
            "description": "To optimize inbound traffic flows and eliminate manual transfers, IntarvAS deploys advanced Interactive Voice Response (IVR) architectures.",
            "features": [
                {
            ...
            "description": "IntarvAS provides management teams with data-driven visibility into customer support and sales performance through powerful quality assurance features.",
            "features": [
                {
                "name": "Tamper-Proof Call Recording",
                "detail": "Every voice interaction is automatically archived in a secure cloud vault for compliance, audit safety, and dispute resolution."
                },
                {
                "name": "Real-Time Call Whispering",
                "detail": "Supervisors can silently listen to live calls and speak directly to an agent's earpiece to provide real-time coaching, completely hidden from the customer."
                }
            ]
            },
            {
            ...
            "description": "Recognizing that WhatsApp is the dominant transactional layer for commerce in Nigeria, IntarvAS embeds the official WhatsApp Business API deep into your business infrastructure, transforming your WhatsApp line into a robust customer service engine.",
            "features": [
                {
            ...
            "description": "To guarantee immediate delivery of time-sensitive alerts, IntarvAS links corporate databases to a heavy-duty outbound SMS gateway.",
            "features": [
                {
